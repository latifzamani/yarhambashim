...
function Events() {
    const events=[
        {title:'A Day with our wonderfull children',date:'2025/1/1',url:'/'},
  ...
  return (
    <Box  sx={{marginY:'5vh'}}>
        ...
        <Box sx={{display:'flex',justifyContent:'center',gap:5}}>
          ...
          <Box key={index} sx={{backgroundColor:'rgb(242,200,75)',width:'40vh',height:'20vh',padding:'2vh',borderRadius:'4%',marginTop:'4vh'}}>
