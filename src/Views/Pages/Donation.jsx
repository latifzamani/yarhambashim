...
function Donation() {
    ...
    return (
        <>
            ...
            <Box sx={{ padding: '5vh' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 12,paddingX:'10vh' }}>
                    <Box sx={{ width: '50%' }}>
                ...
                <hr />
                <br />
                <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 5,paddingX:'10vh' }}>
                    <Typography variant="h6" sx={{ width: '33%' }}>How we use your donation</Typography>
                    <Typography variant="body1" sx={{ width: '33%'}}>This is a describtion on how you use the donation describtion ondonation describtion on how you use thedescribtion how you use thedescribtion on how you use the</Typography>
                    <Typography variant="body1" sx={{ width: '33%' }}>This is a describtion on how you use the donation describtion  how you use thedescribtion on how you use the</Typography>
                </Box>
                <BigImage2 />
            </Box>
        </>
