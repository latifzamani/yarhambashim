...
function AboutUs() {
    ...
    const team=[
        {Fname:'Ahmad Karimi',image:image1,position:'Manager',fUrl:'facebook.com',iUrl:'instagram.com',xUrl:'twitter.com'},
        {Fname:'Ahmad Zamani',image:image1,position:'CEO',fUrl:'facebook.com',iUrl:'instagram.com',xUrl:'twitter.com'},
        {Fname:'Farhad Karimi',image:image1,position:'Manager',fUrl:'facebook.com',iUrl:'instagram.com',xUrl:'twitter.com'},
        {Fname:'Farhad Karimi',image:image1,position:'Manager',fUrl:'facebook.com',iUrl:'instagram.com',xUrl:'twitter.com'},
    ]
                                ...
                                <Card sx={{width:'30vh'}}>
                                    ...
                                    <CardContent>
                                        ...
                                        <Typography sx={{textAlign:'center',marginY:'1vh'}}>
                                            <Link to={member.iUrl}><Instagram sx={{color:"rgb(0,0,0)"}}/></Link>
                                            <Link to={member.fUrl}><Facebook sx={{color:"rgb(0,0,0)",marginX:'1vh'}}/></Link>
                                            <Link to={member.xUrl}><X sx={{color:"rgb(0,0,0)"}}/></Link>
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
